...
class Planet:
    ...
    def __init__(self,orbital_param):
        ...
        self.lamda_bar0 = rad_convert(self.orbital_param[1])
        self.lamda = 0.0
        self.lamda_bar = 0.0
    ...
    def set_pos(self,t):
        ...
        omega_bar = rad_convert(self.orbital_param[4])
        omega = rad_convert(self.orbital_param[5])
        ...
        self.pos[2] = r*rad_convert(self.orbital_param[3])*np.sin(self.lamda-omega)
